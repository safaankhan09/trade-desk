...
function renderJournal(entries) {
  ...
  totalTradesEl.textContent = String(totalTrades);
  winRateEl.textContent = `${formatNumber(winRate)}%`;
  avgWinnerEl.textContent = formatNumber(avgWinner);
  avgLoserEl.textContent = formatNumber(avgLoser);
  bestSymbolEl.textContent = bestSymbol;
  worstSymbolEl.textContent = worstSymbol;
}
